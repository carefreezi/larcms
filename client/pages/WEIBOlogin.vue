<template>
    <div className="main view-1180" style="text-align:center;padding:200px;">
        <i className="el-icon-loading" style="font-size: 40px;"></i>
        <p style="line-height: 60px;">微博正在授权中...</p></div>
</template>
<script>
...
export default {
    ...
    created() {
        ...
        return axios.post(`/api/socials/weibo/authorizations`, {
