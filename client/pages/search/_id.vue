        ...
        <div class="boxTop">
            ...
            <div class="main">
                <div class="row topshowbox">
                    <div class="col-12">
                        <div class="ListTit">
                            {{ '搜索内容：'+tops }} <span class="badge badge-pill badge-primary timer"
...
<script>
import {search_page} from '~/plugins/index'
...
export default {
    ...
    async asyncData({app, params}) {
        let [listA] = await Promise.all([
            app.$axios.$get(`/api/search`, {params: {other: params.id}}),
        ])
        return {
            content: listA.content,
            total: listA.number,
            title: '搜索内容:'+params.id,
            tops:params.id
        }
    },
    ...
    methods: {
        ...
        handleCurrentChange(val) {
            ...
            this.page = val;
            if (this.selradio == 1) {
                search_page(this.$route.params.id, this.page, this.limit).then(response => {
        ...
        async addClassFun(index, page) {
            ...
            if (index == 0) {
                ...
                this.loadings = true;
                return axios.get(`/api/search_select`, {
                    params: {
                        other: this.$route.params.id,
                        page: this.page,
                        limit: this.limit,
        ...
        async vip_select(index, page) {
            ...
            if (index == 1) {
                this.loadings = true;
                return axios.get(`/api/search_Vipselect`, {
                    params: {
                        other: this.$route.params.id,
                        types: 'alls',
                        page: this.page,
