        ...
        <el-row :gutter="20">
            <el-col :xs="24" :sm="20" :md="20" :lg="20" :xl="20">
                <div class="write_body">
                    <el-form ref="postForm" v-if="verify_state==1" :model="postForm" :rules="rules">
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            this.$refs.postForm.validate(valid => {
                if (valid) {
                    this.loading = true
                    return axios.post(`/api/create_article`, {
    ...
    watch: {
        ...
        //             window.tinymce.get(this.tinymceId).setContent(val || ''))
        //     }
        //     this.postForm.content = newValue == null ? '' : newValue
        // },
        myValue(newValue) {
