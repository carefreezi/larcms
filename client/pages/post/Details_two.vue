    ...
    <div>
        ...
        <div class="main top-20 bt-20">
            <div class="clearfix detailsmain">
                                        ...
                                        <div class="api" slot="content">
                                            <div class="post-social">
                                                <a :href="'https://connect.qq.com/widget/shareqq/index.html?url='+web+'&title='+designs.title+'&summary=内容'"
                                                   target="_blank" class="btn btn-light btn-icon btn-qq btn-rounded btn-md"><span><i
                                                ...
                                                >
                                                    <div>
                                                        <div slot="title" style="text-align: center;">
                                                            <div
                                                                ...
                                                                <i class="ivu-icon ivu-icon-ios-checkmark-circle"></i></div>
                                                        </div>
                                                        <div class="api" slot="content">
                                                    ...
                                                    <a href="javascript:;" @mouseover="wechat_ka" slot="reference"
                                ...
                                <div class="app-group">
                                    <div class="comment-box">
                                        <div class="emoji-box">
                                            ...
                                            <el-button type="primary" @click="commit_sub" placeholder="说点什么吧~">提交评论</el-button>
                                        </div>
                                    </div>
                                </div>
                            </el-form>
                            <div class="comment-box">
                                <ul class="comment">
                                    <ul class="comments-list">
                                        <detail-list :list="comments" :member="member" :designs="designs" :comment_all="list"/>
                                    </ul>
                                </ul>
                            </div>
                        </div>
                ...
                <!--Right-->
                <div class="Rightmeun float-right">
                    <div class="Right-Top">
                        <div class="btn-down-box-two">
                                ...
                                >
                                    ...
                                    <el-link slot="reference" :underline="false" target="_blank"
                                        ...
                                        <el-button type="primary" class="download-jifen-btn">
                                            <i class="el-icon el-icon-wallet"></i> 立即下载
                                        </el-button>
                                    </el-link>
                                </el-popover>
                                <el-button type="primary" class="download-jifen-btn"
                                           v-if="post_prices==null&&designs.vip_price==null&&isposts!=1">
                                    <i class="el-icon el-icon-wallet"></i> 无资源下载
                                </el-button>
                                ...
                                >
                                    ...
                                    <div class="styles__withdrawal_way_content__3_3g0">
                                        ...
                                        <div class="styles__button_group__3Q8uW">
                                            ...
                                            <div :class="{'styles__active__1DnYl':payment==3}" v-if="designs.integral!=null"
                        ...
                        <div class="suicai-tips" v-if="designs.show_url">
                            需要查看演示？<a :href="designs.show_url" target="_blank">查看演示</a>
                        </div>
                        <div class="parameter-box">

                        </div>
                        <div class="tag-shucai-box"  v-if="designs.tags!='[]'">
                            <p>标签</p>
                            <nuxt-link :to="'/tags/'+element"  v-for="(element, index) in JSON.parse(designs.tags)">
                                <span rel="tag" class="tag-b">
                                        {{ element }}
                                </span>
                            </nuxt-link>
                        </div>
